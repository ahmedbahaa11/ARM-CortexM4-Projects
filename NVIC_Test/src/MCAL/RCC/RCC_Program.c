...
void RCC_voidInitSystemClock (void)
{
        ...
        CLEAR_BIT(RCC_CR,16U);               // Disable HSE Before Configer bypassing
        CLEAR_BIT(RCC_CR,18U);               // Not bypassed
...
void RCC_voidDisablePeripheralClock ( u8 Copy_u8BusID , u8 Copy_u8PeripheralID)
{
    ...
    else
    {
        switch(Copy_u8BusID)
        {
            case AHB1 :   CLEAR_BIT(RCC_AHB1ENR,(Copy_u8PeripheralID - 0  ));   break;
            case AHB2 :   CLEAR_BIT(RCC_AHB2ENR,(Copy_u8PeripheralID - 32 ));   break;
            case APB1 :   CLEAR_BIT(RCC_APB1ENR,(Copy_u8PeripheralID - 64 ));   break;
            case APB2 :   CLEAR_BIT(RCC_APB2ENR,(Copy_u8PeripheralID - 128));   break;
            default :                                                           break;
        }
    }
}
