/*=================================================================================*/
/*  File        : RTOS_Program.c                                                   */
/*  Description : This file includes RTOS Driver implementations for stm32f401CC   */
...
void RTOS_voidInit (void)
{
    /* Init SYSTICK */
    STK_voidInit();
    /* Set Scheduler at Interval Periodic */
    STK_voidSetIntervalPeriodic(1,&RTOS_voidScheduler);  // 1 msec interval
}
